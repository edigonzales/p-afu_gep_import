...
GDI:
```
java -jar /Users/stefan/apps/ili2pg-4.11.1/ili2pg-4.11.1.jar --dbhost geodb-t.rootso.org --dbport 5432 --dbdatabase edit --dbusr bjsvwzie --dbpwd 222S.pellegrino --dbschema afu_gep_v1 --models "SIA405_Base_Abwasser_LV95" --disableValidation --defaultSrsCode 2056 --dataset organisation --importBid --import data/vsa_organisationen.xtf
```
