...
INSERT INTO se_wk_pub.saa_sbw (baujahr, baulicherzustand, betreiber_bezeichnung, betreiber_organisationstyp, bezeichnung, eigentuemer_bezeichnung, eigentuemer_organisationstyp, funktion, funktionhierarchisch, lage, oid_dss, astatus, dataset, stilid, zustandserhebung_jahr)
  SELECT
    baujahr,
    baulicherzustand,
