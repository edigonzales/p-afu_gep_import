 ...
 * Inhalt:                PAA Sonderbauwerke
 * Script:                vsadssmini_paa_sbw.sql
 ...
 * 0.7.0                  (she) Anpassung Zielmodell, Ergänzung Dataset
 */
...
INSERT INTO se_wk_pub.paa_sbw (baujahr, baulicherzustand, betreiber_bezeichnung, betreiber_organisationstyp, bezeichnung, eigentuemer_bezeichnung, eigentuemer_organisationstyp, funktion, funktionhierarchisch, lage, oid_dss, astatus, dataset, stilid, zustandserhebung_jahr)
  SELECT
    baujahr,
    baulicherzustand,
